...
const I18n = (() => {
    ...
    const TRANSLATIONS = {
        he: {
            ...
            buildings_by_flood: 'מבנים (מול גובה הגל)',
            below_flood: 'נמוך מגובה הגל',
            above_flood: 'גבוה מגובה הגל',
        ...
        en: {
            ...
            buildings_by_flood: 'Buildings (vs wave height)',
            below_flood: 'Lower than the wave',
            above_flood: 'Higher than the wave',
        ...
        ru: {
            ...
            buildings_by_flood: 'Здания (относительно высоты волны)',
            below_flood: 'Ниже высоты волны',
            above_flood: 'Выше высоты волны',
        ...
        fr: {
            ...
            buildings_by_flood: 'Bâtiments (vs hauteur de vague)',
            below_flood: 'Plus bas que la vague',
            above_flood: 'Plus haut que la vague',
        ...
        es: {
            ...
            buildings_by_flood: 'Edificios (vs altura de ola)',
            below_flood: 'Más bajo que la ola',
            above_flood: 'Más alto que la ola',
